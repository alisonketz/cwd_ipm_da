...
#################################################################
    # y_recap_surv_censored = d_fit_recap$surv_censor,
    # left_recap = d_fit_recap$left,
    # right_recap = d_fit_recap$right,
    # sex_recap = d_fit_recap$sex,
    # age2date_recap = d_fit_recap$age2date,

    # y_idead_surv_censored = d_fit_idead$surv_censor,
    # left_idead = d_fit_idead$left,
    # right_idead = d_fit_idead$right,
    # sex_idead = d_fit_idead$sex,
    # age2date_idead = d_fit_idead$age2date,

    # y_sus_draw_surv_censored = d_fit_sus_draw$surv_censor,
    # left_sus_draw = d_fit_sus_draw$left,
    # right_sus_draw = d_fit_sus_draw$right,
    # sex_sus_draw = d_fit_sus_draw$sex,
    # age2date_sus_draw = d_fit_sus_draw$age2date,

    # y_sus_mort_postno_surv_censored = d_fit_sus_mort_postno$surv_censor,
    # left_sus_mort_postno = d_fit_sus_mort_postno$left,
    # right_sus_mort_postno = d_fit_sus_mort_postno$right,
    # sex_sus_mort_postno = d_fit_sus_mort_postno$sex,
    # age2date_sus_mort_postno = d_fit_sus_mort_postno$age2date,

    # y_rec_neg_cens_postno_surv_censored = d_fit_rec_neg_cens_postno$surv_censor,
    # left_rec_neg_cens_postno = d_fit_rec_neg_cens_postno$left,
    # right_rec_neg_cens_postno = d_fit_rec_neg_cens_postno$right,
    # sex_rec_neg_cens_postno = d_fit_rec_neg_cens_postno$sex,
    # age2date_rec_neg_cens_postno = d_fit_rec_neg_cens_postno$age2date,
