...
nimData <- list(Z_period = Z_period,
    ...
    rec_pos_cens_agemonth_recap = d_fit_rec_pos_cens$agemonth_recap,
    ...
    rec_pos_mort_agemonth_recap = d_fit_rec_pos_mort$agemonth_recap,
    ...
    rec_neg_cens_postno_agemonth_recap = d_fit_rec_neg_cens_postno$agemonth_recap,
...
nimConsts <- list(n_year = n_year,
    ...
    nT_age_surv_aah_f_foi = nT_age_surv_aah_f_foi,
    nT_age_surv_aah_m_foi = nT_age_surv_aah_m_foi,
    nT_age_short_f_foi = nT_age_short_f_foi,
    nT_age_short_m_foi = nT_age_short_m_foi,
