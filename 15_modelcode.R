...
<<<<<<< HEAD
  for (i in 1:n_fit_hunt){
    y_hunt_foi_teststatus[i] ~ dFOIhunt(n_cases = n_cases_foi_hunt[1:n_fit_hunt],
            ...
            age_lookup_f = age_lookup_f[1:nT_foi],
            age_lookup_m = age_lookup_f[1:nT_foi],
...
=======
  ...
  #   )
  # }
>>>>>>> a30dccefdadbec34b3fefbdc20623dbae728a2c3
...
<<<<<<< HEAD
#         recap_age = rec_pos_cens_agemonth_recap,
=======
...
<<<<<<< HEAD
#         recap_age = rec_pos_mort_agemonth_recap[i],
=======
...
<<<<<<< HEAD
#         recap_age = rec_neg_cens_postno_agemonth_recap[i],
=======
